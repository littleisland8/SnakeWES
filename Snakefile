...
if config["run_mode"] == "PoN":
	...
	rule PoN:
		input:
			...
			expand(f"SnakeWES/qc/{{sample}}_control_{{strand}}_fastqc.html", sample=config["controls"].values(), strand=config["strand"].values()),
			expand(f"SnakeWES/qc/{{sample}}_tumor_{{strand}}_tr_fastqc.html", sample=config["samples"].values(), strand=config["strand"].values()),
			expand(f"SnakeWES/qc/{{sample}}_control_{{strand}}_tr_fastqc.html", sample=config["controls"].values(), strand=config["strand"].values()),
			expand(f"SnakeWES/qc/{{sample}}.tumor.qc.tsv.gz.pdf", sample=config["samples"].values()),
			expand(f"SnakeWES/qc/{{sample}}.control.qc.tsv.gz.pdf", sample=config["controls"].values()),
			expand(f"SnakeWES/results/{{sample}}_tumor/{{sample}}.{{caller}}.filtOnCtrs.vep.tsv", sample=config["samples"].values(), caller=config["callers"].values()),
			expand(f"SnakeWES/results/multisample.{{caller}}.vep.tsv", caller=config["callers"].values()),
	...
	rule PureCN:
		input:
			expand(f"SnakeWES/alignments/{{sample}}.tumor.coveragePureCN.loess.txt", sample=config["samples"].values()),
			expand(f"SnakeWES/alignments/{{sample}}.control.coveragePureCN.loess.txt", sample=config["controls"].values()),
			expand(f"SnakeWES/results/{{sample}}_tumor/{{sample}}.{{caller}}.filtOnCtr.vep.tmp01.tsv", sample=config["samples"].values(), caller=config["callers"].values()),
			expand(f"SnakeWES/results/multisample.{{caller}}.vep.tmp01.tsv", caller=config["callers"].values()) 
	...
	rule Nocontrols:
		input:
			...
			expand(f"SnakeWES/qc/{{sample}}.tumor.qc.tsv.gz.pdf", sample=config["samples"].values()),
			expand(f"SnakeWES/results/multisample.{{caller}}.vcf.gz", caller=config["callers"].values()),
			expand(f"SnakeWES/results/{{sample}}_tumor/{{sample}}.{{caller}}.filt.vep.vcf.gz", sample=config["samples"].values(), caller=config["callers"].values()),
			expand(f"SnakeWES/results/multisample.{{caller}}.vep.vcf.gz", caller=config["callers"].values()),
			expand(f"SnakeWES/results/{{sample}}_tumor/{{sample}}.{{caller}}.filt.vep.tsv", sample=config["samples"].values(), caller=config["callers"].values()),
			expand(f"SnakeWES/results/multisample.{{caller}}.vep.tsv", caller=config["callers"].values()),
